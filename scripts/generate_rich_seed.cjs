...
const PRODUCT_TEMPLATES = {
  ...
  'Two Wheeler Parts': [
    ...
    { name: 'TVS Apache RTR 160 Rear Brake Shoe Set', brand: 'TVS Genuine', mrp: 380, basePrice: 299, img: 'https://images.unsplash.com/photo-1486006920555-c77dce18193b?auto=format&fit=crop&w=600&q=80', kw: ['tvs', 'apache', 'brake shoe', 'bike parts'] },
    ...
    { name: 'NGK G-Power Platinum Spark Plug (CPR8EAGP-9)', brand: 'NGK', mrp: 220, basePrice: 175, img: 'https://images.unsplash.com/photo-1486006920555-c77dce18193b?auto=format&fit=crop&w=600&q=80', kw: ['ngk', 'spark plug', 'bike ignition', 'platinum plug'] },
  ...
  'Batteries & Electricals': [
    ...
    { name: 'Roots Windtone 12V High-Tone Electric Car Horn Pair', brand: 'Roots', mrp: 850, basePrice: 650, img: 'https://images.unsplash.com/photo-1486006920555-c77dce18193b?auto=format&fit=crop&w=600&q=80', kw: ['roots horn', 'windtone', 'car horn', 'loud horn'] },
    { name: 'Philips H4 12V 60/55W X-tremeVision Pro150 Headlight Bulb', brand: 'Philips', mrp: 750, basePrice: 580, img: 'https://images.unsplash.com/photo-1486006920555-c77dce18193b?auto=format&fit=crop&w=600&q=80', kw: ['philips h4', 'headlight bulb', 'car bulb', 'white light'] },
    { name: 'Osram Night Breaker Laser H7 Halogen Headlamp Bulb Pair', brand: 'Osram', mrp: 1850, basePrice: 1390, img: 'https://images.unsplash.com/photo-1486006920555-c77dce18193b?auto=format&fit=crop&w=600&q=80', kw: ['osram h7', 'night breaker', 'headlight bulb', 'laser bulb'] },
    { name: 'Uno Minda 12V Heavy Duty Headlight Relay Wiring Harness Kit', brand: 'Uno Minda', mrp: 450, basePrice: 340, img: 'https://images.unsplash.com/photo-1486006920555-c77dce18193b?auto=format&fit=crop&w=600&q=80', kw: ['relay kit', 'minda relay', 'headlight harness', 'wiring kit'] },
    { name: 'Bosch 12V Symphony FC4 Car Horn Chrome Dual Set', brand: 'Bosch', mrp: 950, basePrice: 740, img: 'https://images.unsplash.com/photo-1486006920555-c77dce18193b?auto=format&fit=crop&w=600&q=80', kw: ['bosch horn', 'symphony horn', 'car horn', 'dual horn'] },
    { name: 'Microtek 12V Automatic Smart Battery Charger for Car/Bike', brand: 'Microtek', mrp: 1899, basePrice: 1399, img: 'https://images.unsplash.com/photo-1486006920555-c77dce18193b?auto=format&fit=crop&w=600&q=80', kw: ['battery charger', 'trickle charger', 'microtek battery charger'] }
  ],
  'Tyres & Tubes': [
  ...
  'Cables, Chargers & Hubs': [
    ...
    { name: 'boAt Rugged v3 Extra Tough Braided Type-C Fast Charging Cable (1.5M)', brand: 'boAt', mrp: 799, basePrice: 299, img: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?auto=format&fit=crop&w=600&q=80', kw: ['type c cable', 'boat cable', 'braided cable', 'fast charging wire'] },
    { name: 'Anker PowerLine III Flow Silicone USB-C to Lightning Cable (3ft)', brand: 'Anker', mrp: 1999, basePrice: 1399, img: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?auto=format&fit=crop&w=600&q=80', kw: ['lightning cable', 'anker cable', 'iphone cord', 'silicone cable'] },
  ...
  'First Aid & Surgicals': [
    { name: 'Dettol Antiseptic Disinfectant Liquid 550ml Bottle', brand: 'Dettol', mrp: 220, basePrice: 198, img: 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?auto=format&fit=crop&w=600&q=80', kw: ['dettol', 'antiseptic', 'wound wash', 'first aid', 'disinfectant'] },
  ...
  // =========================================================================
  'Hand & Power Tools': [
    { name: 'Stanley 12-Piece Cushion Grip Magnetic Screwdriver & Hand Toolset', brand: 'Stanley', mrp: 1299, basePrice: 899, img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=600&q=80', kw: ['stanley screwdriver', 'tools', 'hand tools', 'magnetic screwdriver set'] },
    ...
    { name: 'Taparia 8-Inch Steel Combination Pliers with Insulated Grip', brand: 'Taparia', mrp: 310, basePrice: 245, img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=600&q=80', kw: ['taparia plier', 'combination pliers', 'hand plier', 'electrician tool'] },
    { name: 'Taparia 10-Inch Heavy Duty Adjustable Spanner Wrench', brand: 'Taparia', mrp: 480, basePrice: 390, img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=600&q=80', kw: ['adjustable wrench', 'slide wrench', 'spanner', 'taparia wrench'] },
    ...
    { name: 'Stanley 5-Meter Steel Metric Measuring Tape with Locking Mechanism', brand: 'Stanley', mrp: 290, basePrice: 199, img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=600&q=80', kw: ['measuring tape', 'stanley 5m tape', 'inch tape', 'survey tape'] },
    { name: 'Taparia 500g Drop Forged Carbon Steel Claw Hammer with Fiberglass Handle', brand: 'Taparia', mrp: 390, basePrice: 299, img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=600&q=80', kw: ['claw hammer', 'hathoda', 'taparia hammer', 'carpenter hammer'] },
    { name: 'Stanley 9-Piece Hex Ball-End Allen Key Keyring Set Metric', brand: 'Stanley', mrp: 420, basePrice: 315, img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=600&q=80', kw: ['allen key', 'hex key set', 'stanley allen key', 'l key'] },
    ...
    { name: 'Taparia 86-Piece Master Socket & Ratchet Wrench Tool Set Case', brand: 'Taparia', mrp: 4950, basePrice: 3890, img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=600&q=80', kw: ['socket set', 'ratchet wrench', 'mechanic toolkit', 'taparia set'] }
  ],
  'Electricals & Wiring': [
    { name: 'Havells LifeLine Plus 1.5 sq mm Single Core FR-LSH Copper Wire 90m (Red)', brand: 'Havells', mrp: 2150, basePrice: 1790, img: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?auto=format&fit=crop&w=600&q=80', kw: ['havells wire', '1.5 sq mm wire', 'copper wire', 'house wiring wire'] },
    { name: 'Polycab Optima Plus 2.5 sq mm Flame Retardant Copper Wire 90m (Blue)', brand: 'Polycab', mrp: 3400, basePrice: 2850, img: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?auto=format&fit=crop&w=600&q=80', kw: ['polycab wire', '2.5 sq mm wire', 'ac wiring wire', 'electric cable'] },
    { name: 'Anchor Roma Classic 6A 1-Way Modular White Light Switch (Pack of 10)', brand: 'Anchor by Panasonic', mrp: 380, basePrice: 290, img: 'https://images.unsplash.com/photo-1558981806-ec527fa84c39?auto=format&fit=crop&w=600&q=80', kw: ['anchor roma', 'modular switch', '6a switch', 'light switch'] },
    { name: 'Anchor Roma 16A 3-Pin Power Socket with Shutter (Pack of 5)', brand: 'Anchor by Panasonic', mrp: 450, basePrice: 360, img: 'https://images.unsplash.com/photo-1558981806-ec527fa84c39?auto=format&fit=crop&w=600&q=80', kw: ['16a socket', 'power socket', 'roma socket', 'plug socket'] },
    { name: 'Havells 9W Cool Day White B22 Base LED Bulb (Pack of 4)', brand: 'Havells', mrp: 520, basePrice: 360, img: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?auto=format&fit=crop&w=600&q=80', kw: ['led bulb', 'havells bulb', '9w led', 'b22 bulb'] },
    { name: 'Schneider Electric Acti9 32A Double Pole MCB C-Curve', brand: 'Schneider Electric', mrp: 690, basePrice: 540, img: 'https://images.unsplash.com/photo-1558981806-ec527fa84c39?auto=format&fit=crop&w=600&q=80', kw: ['mcb', 'schneider mcb', '32a double pole', 'circuit breaker'] },
    { name: 'Orient Electric 1200mm Apex-FX High Speed Ceiling Fan (Brown)', brand: 'Orient', mrp: 2190, basePrice: 1699, img: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?auto=format&fit=crop&w=600&q=80', kw: ['ceiling fan', 'orient fan', 'high speed fan', 'pankha'] },
    { name: 'Luminous Zelio+ 1100 Pure Sine Wave Home UPS Inverter (900VA / 12V)', brand: 'Luminous', mrp: 7490, basePrice: 5890, img: 'https://images.unsplash.com/photo-1558981806-ec527fa84c39?auto=format&fit=crop&w=600&q=80', kw: ['inverter', 'luminous zelio', 'sine wave inverter', 'home ups'] },
    { name: 'Anchor PVC Self-Adhesive Electrical Insulation Tape (Pack of 5)', brand: 'Anchor', mrp: 90, basePrice: 70, img: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?auto=format&fit=crop&w=600&q=80', kw: ['electrical tape', 'wire tape', 'black tape', 'anchor tape'] },
    { name: 'GM 4-Outlet Heavy Duty Spike Guard Extension Board with 2M Cord', brand: 'GM Modular', mrp: 690, basePrice: 480, img: 'https://images.unsplash.com/photo-1544716278-ca5e3f4abd8c?auto=format&fit=crop&w=600&q=80', kw: ['extension board', 'spike guard', 'multi plug board', 'gm extension'] }
  ],
  'Plumbing & Pipes': [
    { name: 'Astral CPVC Pro 1-Inch Pipe Class 1 SDR 11 (3-Meter Length)', brand: 'Astral Pipes', mrp: 480, basePrice: 395, img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=600&q=80', kw: ['cpvc pipe', 'astral pipe', '1 inch water pipe', 'plumbing pipe'] },
    { name: 'Supreme UPVC 3/4-Inch Ball Valve Brass Threaded', brand: 'Supreme', mrp: 290, basePrice: 220, img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=600&q=80', kw: ['ball valve', 'water valve', 'supreme pipe fitting'] },
    ...
    { name: 'Cera 2-in-1 Wall Mixer with Provision for Hand Shower', brand: 'Cera', mrp: 3450, basePrice: 2690, img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=600&q=80', kw: ['wall mixer', 'cera tap', 'bathroom mixer', 'shower tap'] },
  ...
  'Fasteners & Hardware': [
    { name: 'Godrej Nav-Tal 7 Levers High Security Brass Padlock with 3 Keys', brand: 'Godrej', mrp: 620, basePrice: 499, img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=600&q=80', kw: ['godrej lock', 'navtal lock', 'brass padlock', 'tala', 'door lock'] },
    { name: 'Europa High Security Rim Main Door Lock with 3 Dimple Keys', brand: 'Europa', mrp: 2450, basePrice: 1890, img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=600&q=80', kw: ['europa door lock', 'main door lock', 'night latch'] },
    { name: 'Heavy Duty Stainless Steel 304 Bearing Door Hinges 4-Inch (Pack of 3 Pairs)', brand: 'Dorset', mrp: 750, basePrice: 580, img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=600&q=80', kw: ['door hinges', 'ss hinges', 'kabza', '4 inch hinges'] },
    { name: 'Zinc Plated Steel Self-Drilling Drywall Screws 1.5-Inch (Box of 500)', brand: 'ForgeMaster', mrp: 450, basePrice: 340, img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=600&q=80', kw: ['drywall screws', 'screws box 500', 'hardware screws', 'pech'] },
    { name: 'Godrej Classic Cylindrical Stainless Steel Bedroom Door Lock', brand: 'Godrej', mrp: 1250, basePrice: 950, img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=600&q=80', kw: ['cylindrical lock', 'godrej round lock', 'bedroom lock'] },
    { name: 'Fischer Nylon Wall Plugs Rawl Plugs 8mm with Screws (Pack of 100)', brand: 'Fischer', mrp: 320, basePrice: 230, img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=600&q=80', kw: ['wall plugs', 'gitti', 'rawl plugs', 'fischer 8mm'] },
    { name: 'Ozone Hydraulic Automatic Aluminum Door Closer 60kg Load', brand: 'Ozone', mrp: 1450, basePrice: 1090, img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=600&q=80', kw: ['door closer', 'hydraulic door closer', 'ozone door'] },
    { name: 'Heavy Duty Solid Brass Tower Bolt Door Latch 8-Inch', brand: 'Dorset', mrp: 420, basePrice: 310, img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=600&q=80', kw: ['tower bolt', 'chitkani', 'door latch', 'brass bolt'] },
    { name: 'High Tensile Grade 8.8 Hex Bolts with Nuts M10 x 50mm (Pack of 50)', brand: 'Unbrako', mrp: 480, basePrice: 370, img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=600&q=80', kw: ['hex bolts', 'nut bolt set', 'm10 bolts', 'unbrako'] },
    { name: 'Dorset Stainless Steel Main Door Pull Handle 12-Inch Pair', brand: 'Dorset', mrp: 1150, basePrice: 850, img: 'https://images.unsplash.com/photo-1581783342308-f792dbdd27c5?auto=format&fit=crop&w=600&q=80', kw: ['door handle', 'pull handle', 'ss handle'] }
  ],
